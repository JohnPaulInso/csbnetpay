...
Advance Payment is the difference in amortizations multiplied by the number of advance payment months, where checking/unchecking the box determines whether PLI deductions are deducted from the basis:
...
Advance Payment = (New CSB Amortization - Sum of Checked CSB Deductions) * Advance Payment Months
